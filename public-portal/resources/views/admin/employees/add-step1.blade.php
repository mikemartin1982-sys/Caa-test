...
@section('content')
    <h1>Add Employee</h1>
    <p class="hint" style="margin-bottom:1.5rem;">Start typing a company name to add a new employee to that client's roster.</p>
    ...
    (function () {
        ...
        flyout.addEventListener('click', function (e) {
            ...
            if (!opt) return;
            window.location.href = '{{ url('/admin/employees/add') }}/' + opt.dataset.id;
        });
