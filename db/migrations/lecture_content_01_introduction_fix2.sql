...
-- Reference: Michael, 2026-09-07 -- design request: Course Assistance and
-- Quiz Structure should be real, collapsible toggle sections (matching
-- the real, live course), not plain, always-visible text, so the page
-- isn't large by default. Uses the shared .lect-toggle CSS and
-- lectureToggle() JS added to lecture/layout.blade.php. UPDATE, not a
-- new INSERT -- the row already exists.
-- ============================================================================
